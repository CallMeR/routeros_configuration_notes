...
## 计算文件 hash
$ sha256sum chr-7.14.img.zip

#### 文件 hash 示例输出
5b4fcb37ad17ee60a9f0a0c9dd773a6df729defedd454536193fb5c926318f67  chr-7.14.img.zip
```
...
```bash
## 将 img 镜像导入虚拟机中
$ qm importdisk 101 chr-7.14.img local-lvm
