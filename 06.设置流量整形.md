...
```bash
/queue type
add name=fq-codel-rx kind=fq-codel fq-codel-limit=1024 fq-codel-quantum=512 fq-codel-memlimit=16.0MiB
add name=fq-codel-tx kind=fq-codel fq-codel-limit=768 fq-codel-quantum=384 fq-codel-memlimit=16.0MiB
