...
- 对于使用 **CHR 版本** RouterOS 的软路由  
    ...
    - 系统资源邮件脚本，请查阅文件 [ros_email_chr_res_worker.conf](./src/email/ros_email_chr_res_worker.conf)  
...
- 对于使用 **Mikrotik 原生** RouterOS 的硬路由  
    ...
    - 系统日志邮件脚本，与 CHR 版本相同  
    - 系统资源邮件脚本，与 CHR 版本略有不同，请查阅文件 [ros_email_native_res_worker.conf](./src/email/ros_email_native_res_worker.conf)  
...
- CHR 使用：[ros_email_chr_res_worker.conf](./src/email/ros_email_chr_res_worker.conf)  

- 官方硬件使用：[ros_email_native_res_worker.conf](./src/email/ros_email_native_res_worker.conf)  
